...
class ImageApprovalApp(QMainWindow):
    ...
    def initUI(self):
        self.setWindowTitle("Image Approval App")

        # Set the application icon using QIcon
        if os.path.exists('icon.png'):
            app_icon = QIcon('icon.png')  # Replace 'your_icon.png' with the actual icon file path
    ...
    def onApprove(self):
        if self.current_image < len(self.image_list):
            ...
            new_data = {'ImageName': [image_name], 'Approved': ['Approved']}
    ...
    def saveDataFrameToExcel(self):
        ...
        self.image_data.to_excel(excel_file_name, index=False)
